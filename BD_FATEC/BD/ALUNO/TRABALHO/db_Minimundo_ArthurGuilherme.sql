...
VALUES
	...
	(10, '1990-5-12', '010.010.010-10', null),
	(11, '1990-6-14', '011.011.011-11', null)
GO
...
-----------------------------------------------------------------
-- 2) Faça uma consulta que traga todos os livros e seus respectivos assuntos.
-----------------------------------------------------------------
SELECT
	livro.id,
	livro.titulo,
...
-----------------------------------------------------------------
-- 3) Faça uma consulta para obter todos os livros que, quando comprados, tiveram desconto na compra.
-----------------------------------------------------------------
SELECT
	livro.id,
	livro.titulo,
...
-----------------------------------------------------------------
-- 4) Faça uma consulta que traga todos os livros que foram ou não 
...
-----------------------------------------------------------------
-- 5) Faça uma consulta que traga todos os clientes que são pessoa física (use Inner Join).
-----------------------------------------------------------------
SELECT
	cliente.id,
	cliente.nome,
...
-----------------------------------------------------------------
-- 6) Faça alteração de preço de todos os livros do assunto “Romance”, aumentando o preço em 10%.
-----------------------------------------------------------------
UPDATE 
	livro 
SET 
...
-----------------------------------------------------------------
-- 7) Inative o cliente sempre que desejar excluí-lo do Banco de Dados,
...
-----------------------------------------------------------------
-- 8) Exclua o telefone de todos os clientes pessoa jurídica cujo valor da compra seja maior que R$ 100.000,00.
...
FROM
	...
	INNER JOIN cliente_empresa
		ON cliente_empresa.id_cliente = cliente_telefone.id_cliente
		INNER JOIN compra
			ON compra.id_cliente = cliente_empresa.id_cliente
			AND compra.total_compra > 1000 -- id 17, Villa Calui

SELECT * FROM cliente_telefone

-----------------------------------------------------------------
-- 9) Calcule o valor de cada compra.
-----------------------------------------------------------------
SELECT
...
-----------------------------------------------------------------
-- 10) Encontre o livro mais caro, o mais barato, o preço médio dos livros.
-----------------------------------------------------------------
SELECT
